...
## Version history
- #### v0.7.4.9
    + для выхода на клапан1 (воды) добавлено управление ШИМ(20кГц) c WEB
    + исправлен баг: циклическая перезагрузка после ресета, при разгоне на первом, после прошивки, ректе  
- #### v0.7.4.8
    + на WEBстранице отображается условие завершения этапа (температура или время) 
    + добавлена настройка "ШИМ удержания клапанов"
- #### v0.7.4.7
